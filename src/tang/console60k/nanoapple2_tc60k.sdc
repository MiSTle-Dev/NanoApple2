...
set_clock_groups -asynchronous -group [get_clocks {ds2_clk}] -group [get_clocks {ds_clk}]  -group [get_clocks {clk_audio}] -group [get_clocks {clk28}] -group [get_clocks {clk14}] -group [get_clocks {clk_pixel_x5}]
